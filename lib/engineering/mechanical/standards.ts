// ═══════════════════════════════════════════════════════════════════════════
// lib/engineering/mechanical/standards.ts
//
// mechanical-domain engineering standards registry. STUB — populate only with
...
export const MECHANICAL_STANDARDS: StandardEntry[] = [];
