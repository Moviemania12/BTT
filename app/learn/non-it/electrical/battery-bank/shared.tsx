...
export const S = {
  h2: { fontSize: "1.9rem", fontWeight: 800, color: "var(--color-text-primary)", marginTop: "3rem", marginBottom: "1rem", letterSpacing: "-0.01em" } as const,
  h3: { fontSize: "1.35rem", fontWeight: 700, color: "var(--color-text-primary)", marginTop: "2rem", marginBottom: "0.75rem" } as const,
  p: { fontSize: "1.05rem", lineHeight: 1.75, color: "var(--color-text-secondary)", marginBottom: "1rem" } as const,
  ul: { fontSize: "1.05rem", lineHeight: 1.8, color: "var(--color-text-secondary)", marginBottom: "1rem", paddingLeft: "1.4rem" } as const,
  ol: { fontSize: "1.05rem", lineHeight: 1.8, color: "var(--color-text-secondary)", marginBottom: "1rem", paddingLeft: "1.4rem" } as const,
  ...
  return (
    <>
      <div style={S.quickAnswer}>
        <p style={{ margin: 0, fontSize: "0.8rem", fontWeight: 700, color: "var(--color-neon-blue)", letterSpacing: "0.1em", textTransform: "uppercase", marginBottom: "0.4rem" }}>
          Quick Answer
        </p>
        <p style={{ margin: 0, fontSize: "1rem", lineHeight: 1.7, color: "var(--color-text-secondary)" }}>
          {quickAnswer}
        </p>
      </div>
