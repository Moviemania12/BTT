...
export const metadata: Metadata = {
  title: "AI Data Centers — Behind The Tech",
  description: "AI Data Center basics, GPU clusters, networking, storage aur cooling — AI workloads ke liye infrastructure.",
};

export default function CategoryPage() {
  const topics = getTopicsByCategory("ai", "data-centers");
      ...
      <section className="hp-section hp-section--hero">
        <div className="hp-container hp-container--medium" style={{ textAlign: "center" }}>
          ...
          <p className="hp-body" style={{ margin: "0 auto 20px" }}>
            AI Data Center basics, GPU clusters, networking, storage aur cooling — AI workloads ke liye infrastructure.
          </p>
        </div>
      </section>
