...
export const metadata: Metadata = {
  title: "AI Hardware — Behind The Tech",
  description: "GPUs, TPUs, AI Accelerators, NVIDIA aur AMD architecture — AI ka hardware foundation.",
};
      ...
      <section className="hp-section hp-section--hero">
        <div className="hp-container hp-container--medium" style={{ textAlign: "center" }}>
          ...
          <p className="hp-body" style={{ margin: "0 auto 20px" }}>
            GPUs, TPUs, AI Accelerators, NVIDIA aur AMD architecture — AI ka hardware foundation.
          </p>
        </div>
      </section>
