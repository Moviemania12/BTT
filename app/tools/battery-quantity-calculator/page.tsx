...
import BatteryQuantityCalculator from "@/components/calculators/BatteryQuantityCalculator";
...
// components/calculators/BatteryQuantityCalculator.tsx (shared, reusable,
// route-independent) — this file only wires registry data to the page.
// ═══════════════════════════════════════════════════════════════════════════

const REGISTRY_ID = "ups.battery-quantity-calculator";
...
export default function BatteryQuantityCalculatorPage() {
  const entry = getCalculator(REGISTRY_ID);
  if (!entry) notFound();
