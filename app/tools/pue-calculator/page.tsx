...
// "Power Usage Effectiveness" entry is added to
...
export const metadata: Metadata = {
  title: "PUE Calculator — Coming Soon | Behind The Tech",
  description: "Calculate your Data Center's Power Usage Effectiveness ratio. This calculator is coming soon to Behind The Tech.",
  ...
  return (
    <main style={{ maxWidth: "640px", margin: "0 auto", padding: "4rem 1.25rem", textAlign: "center" }}>
      ...
      <p style={{ fontSize: "1.05rem", color: "#475569", lineHeight: 1.7, marginBottom: "0.5rem" }}>
        Calculate your Data Center&apos;s Power Usage Effectiveness ratio.
      </p>
