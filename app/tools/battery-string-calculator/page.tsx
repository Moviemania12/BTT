...
import BatteryStringCalculator from "@/components/calculators/BatteryStringCalculator";
...
// components/calculators/BatteryStringCalculator.tsx (shared, reusable,
// route-independent) — this file only wires registry data to the page.
// ═══════════════════════════════════════════════════════════════════════════

const REGISTRY_ID = "ups.battery-string-calculator";
...
export default function BatteryStringCalculatorPage() {
  const entry = getCalculator(REGISTRY_ID);
  if (!entry) notFound();
