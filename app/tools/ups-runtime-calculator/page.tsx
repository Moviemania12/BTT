...
import RuntimeCalculator from "@/components/calculators/RuntimeCalculator";
...
// components/calculators/RuntimeCalculator.tsx (shared, reusable,
// route-independent) — this file only wires registry data to the page.
// ═══════════════════════════════════════════════════════════════════════════

const REGISTRY_ID = "ups.runtime-calculator";
...
export default function RuntimeCalculatorPage() {
  const entry = getCalculator(REGISTRY_ID);
  if (!entry) notFound();
